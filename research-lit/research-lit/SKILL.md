---
name: research-lit
description: Search and analyze research papers, find related work, summarize key ideas. Use when the user says find papers, related work, literature review, what does this paper say, or needs to understand academic papers.
...
| 3 | Bundled arXiv helper | `arxiv` | `${CLAUDE_SKILL_DIR}/scripts/arxiv_fetch.py` inside this skill | Structured metadata and optional PDF download |
