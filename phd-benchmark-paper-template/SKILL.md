---
name: phd-benchmark-paper-template
...
For technical and position papers, use the `phd-tech-paper-template` skill. For the Introduction outline in isolation, use `phd-intro-drafter`.
...
- Do not confuse this Introduction flowchart with the technical-paper flowchart; they are structurally different. For technical papers, invoke `phd-tech-paper-template`.
