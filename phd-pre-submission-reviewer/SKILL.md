---
name: phd-pre-submission-reviewer
description: >-
...
- The paper is still being structured. Use `phd-tech-paper-template`, `phd-intro-drafter`, or `phd-benchmark-paper-template` (separate plugin) first.
