...
```bash
python "${CLAUDE_SKILL_DIR}/scripts/pdf_safety_scan.py" "paper.pdf" --output-dir temp_codex/scans
```
...
1. Extract references:
   ```bash
   python "${CLAUDE_SKILL_DIR}/scripts/extract_references.py" "paper.pdf" --output temp_codex/metadata/references_matrix.csv --markdown temp_codex/metadata/references_matrix.md
   ```
