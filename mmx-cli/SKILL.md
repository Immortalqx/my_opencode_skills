...
argument-hint: <mmx-subcommand> [args]
...
| `--poll-interval <seconds>` | number | Polling interval in seconds (default: 5) |
...
| `--channels <n>` | number | Number of channels (default: 1) |
...
| `--mood <text>` | string | Mood or atmosphere, e.g. warm, melancholic, uplifting |
