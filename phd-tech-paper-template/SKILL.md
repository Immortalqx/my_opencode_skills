...
- The paper is a benchmark paper. Use `phd-benchmark-paper-template` (separate plugin).
...
If the user's inputs describe a benchmark, stop and redirect to `phd-benchmark-paper-template` (separate plugin).
