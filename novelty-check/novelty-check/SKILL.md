---
name: novelty-check
description: Verify research idea novelty against recent literature. Use when the user says 查新, 有没有人做过, novelty check, check novelty, or wants to verify a research idea is novel before investing implementation time.
